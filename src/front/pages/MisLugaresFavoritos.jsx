...
export const Favoritos = ({ lista, onDelete, cargando }) => {
    ...
    return (
        <div style={{
            width: "100%",
            padding: "20px 15px 100px 15px", // El padding bottom evita que el footer tape la última card
            display: "flex",
            ...
            {cargando ? (
                ...
                <div className="text-center" style={{
                    ...
                    <i className="fas fa-heart-broken mb-2" style={{ fontSize: "30px", opacity: 0.5 }}></i>
                    <p style={{ fontWeight: "600"}}>No hay sitios guardados</p>
                </div>
